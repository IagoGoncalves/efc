    ...
    <header id="header-desktop">
        <section class="first-line">
            <div class="container align">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/taberna-logo.png" alt="">
                <p class="none">.</p>
				<?php $args = array('post_type' => 'data'); $var = new WP_Query($args); if($var->have_posts()): while($var->have_posts()): $var->the_post();?>																	 
                    <a href="https://api.whatsapp.com/send/?phone=55<?= formatarVariavel(get_field('whatsapp_esporte')) ?>&text=Vim%20através%20do%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" class="whatsapp align">
                        ...
                        <?= get_field('whatsapp_esporte')  ?>
                    </a>
                    <span class="align">
                        <a href="<?= get_field('link_instagram') ?>" target="_blank">
                        ...
                        <a href="<?= get_field('link_facebook') ?>" target="_blank">
                        ...
                        <!-- <a href="<?= get_field('link_linkedin') ?>" target="_blank">
                        ...
                        <a href="<?= get_field('link_youtube') ?>" target="_blank">
